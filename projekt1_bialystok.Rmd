...
names(dekady)<-c("dekada 1950","dekada 1960", "dekada 1970", "dekada 1980", "dekada 1990", "dekada 2000", "dekada 2010")
...
{
  print(ggplot(tabela_srednie_dekadowe, aes(Dekada, tabela_srednie_dekadowe[,i]))+geom_point()+labs(y="Temperatura", title=i))
}
